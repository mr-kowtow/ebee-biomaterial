...
def generate_page(p, all_products):
    ...
    ld = json.dumps({
        ...
        "description": desc,
        "url": canon,
        "brand": {"@type": "Brand", "name": "E-BEE Tableware"},
        "offers": {
            "@type": "Offer",
            "availability": "https://schema.org/InStock",
            "priceCurrency": "USD",
            "seller": {"@type": "Organization", "name": "E-BEE Tableware"}
        }
    })
...
<head>
  ...
  <title>{html_escape(name)} | E-BEE Tableware</title>
  ...
  <meta name="author" content="E-BEE Tableware" />
  <link rel="canonical" href="{canon}" />
  <meta property="og:type" content="product" />
  <meta property="og:site_name" content="E-BEE Tableware" />
  <meta property="og:title" content="{html_escape(name)} | E-BEE Tableware" />
  <meta property="og:description" content="{html_escape(short_desc)}" />
  <meta property="og:image" content="{img_abs}" />
  <meta property="og:url" content="{canon}" />
  <meta name="twitter:card" content="summary_large_image" />
  <meta name="twitter:title" content="{html_escape(name)} | E-BEE Tableware" />
...
<header>
  <div class="header-inner">
    <a href="../../index.html" style="text-decoration:none">
      <img src="../../images/logo-ebee.svg" alt="E-BEE Tableware" style="height:48px;width:auto;" />
    </a>
    <nav id="main-nav">
      <ul>
...
<footer>
  <div class="footer-inner">
    <div class="footer-brand">
      <img src="../../images/logo-ebee.svg" alt="E-BEE Tableware" style="height:44px;width:auto;filter:brightness(1.2);" />
  ...
  <div class="footer-bottom">
    <div>&copy; 2010&ndash;2025 E-BEE Tableware. All Rights Reserved.</div>
